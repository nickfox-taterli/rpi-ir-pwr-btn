...
extern uint8_t Ir_Status;               //红外接收处理状态
extern uint8_t  Ir_Receive_Count;       //红外接收数据位计数
extern uint32_t Ir_Receive_Data;        //32位的红外接收数据
extern uint8_t Ir_receive_ok;           //红外接收完成标志
